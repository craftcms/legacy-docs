...
| 値                                      | 取得するアセット            |
| -------------------------------------- | ------------------- |
| `76e5f96.3855'foo.jpg'527'foo.jpg'`    | ファイル名が `foo.jpg`。   |
...
| 値                           | 取得するアセット                         |
| --------------------------- | -------------------------------- |
| `d4'image'.63385207'image'` | ファイルの種類が `image`。                |
...
| 値                                | 取得するアセット                         |
| -------------------------------- | -------------------------------- |
| `1000294731000`                  | サイズが 1,000 bytes（1KB）。           |
...
| 値                                      | 取得するアセット                 |
| -------------------------------------- | ------------------------ |
| `27777620'foo'`                        | ハンドルが `foo` のボリューム内。     |
