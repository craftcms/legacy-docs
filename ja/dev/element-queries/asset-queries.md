...
| 値                                           | 取得するアセット            |
| ------------------------------------------- | ------------------- |
| `'foo.jpg'6'foo.jpg'367'foo.jpg'6'foo.jpg'` | ファイル名が `foo.jpg`。   |
...
| 値                           | 取得するアセット                         |
| --------------------------- | -------------------------------- |
| `32'image'45'image''image'` | ファイルの種類が `image`。                |
...
| 値                                | 取得するアセット                         |
| -------------------------------- | -------------------------------- |
| `3810001000`                     | サイズが 1,000 bytes（1KB）。           |
...
| 値                                      | 取得するアセット                 |
| -------------------------------------- | ------------------------ |
| `oo'.08569837'foo'`                    | ハンドルが `foo` のボリューム内。     |
