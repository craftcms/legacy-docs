...
| 値                                           | 取得するアセット            |
| ------------------------------------------- | ------------------- |
| `'foo.jpg'53'foo.jpg'342'foo.jpg''foo.jpg'` | ファイル名が `foo.jpg`。   |
...
| 値                           | 取得するアセット                         |
| --------------------------- | -------------------------------- |
| `image''image'77790'image'` | ファイルの種類が `image`。                |
...
| 値                                | 取得するアセット                         |
| -------------------------------- | -------------------------------- |
| `3628710001000`                  | サイズが 1,000 bytes（1KB）。           |
