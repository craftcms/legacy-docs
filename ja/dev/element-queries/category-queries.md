...
| 値                       | 取得するカテゴリ            |
| ----------------------- | ------------------- |
| `0'foo'262'foo'76'foo'` | ハンドルが `foo` のグループ内。 |
...
| 値                                   | 取得するカテゴリ     |
| ----------------------------------- | ------------ |
| `3b8.'Foo''Foo'970'Foo''Foo'4'Foo'` | タイトルが `Foo`。 |
