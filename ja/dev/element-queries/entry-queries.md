...
| 値                                            | 取得するエントリ                |
| -------------------------------------------- | ----------------------- |
| `230afd23.95068274'>= 2018-04-01'`        | 2018-04-01 以降に投稿されたもの。  |
...
| 値                                            | 取得するエントリ                 |
| -------------------------------------------- | ------------------------ |
| `fc4.539'foo'45'foo'9'foo'`                  | ハンドルが `foo` のセクション内。     |
