...
| 値                                   | 取得するエントリ    |
| ----------------------------------- | ----------- |
| `mpty:'7.95':empty:'06255':empty:'` | 有効期限日を持たない。 |
...
| 値                                                      | 取得するエントリ                |
| ------------------------------------------------------ | ----------------------- |
| `29a6b'>= 2018-04-01'a0.64657308'>= 2018-04-01'` | 2018-04-01 以降に投稿されたもの。  |
...
| 値                                            | 取得するエントリ                 |
| -------------------------------------------- | ------------------------ |
| `oo'62239'foo'`                              | ハンドルが `foo` のセクション内。     |
...
| 値                       | 取得するエントリ                        |
| ----------------------- | ------------------------------- |
| `79'foo'85484'foo'`     | ハンドルが `foo` のタイプ。               |
