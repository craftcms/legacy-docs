...
| 値                           | 取得するエントリ    |
| --------------------------- | ----------- |
| `':empty:'5863457':empty:'` | 有効期限日を持たない。 |
...
| 値                                                                                        | 取得するエントリ                |
| ---------------------------------------------------------------------------------------- | ----------------------- |
| `018-04-01'42'>= 2018-04-01'99'>= 2018-04-01''>= 2018-04-01''>= 2018-04-01'` | 2018-04-01 以降に投稿されたもの。  |
...
| 値                                    | 取得するエントリ            |
| ------------------------------------ | ------------------- |
| `foo'2'foo'9'foo''foo'`              | ハンドルが `foo` のサイトから。 |
