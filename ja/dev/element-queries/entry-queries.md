...
| 値                           | 取得するエントリ    |
| --------------------------- | ----------- |
| `empty:'.88382525':empty:'` | 有効期限日を持たない。 |
...
| 値                                                                                        | 取得するエントリ                |
| ---------------------------------------------------------------------------------------- | ----------------------- |
| `dfd7d082.2'>= 2018-04-01''>= 2018-04-01'3468'>= 2018-04-01''>= 2018-04-01'` | 2018-04-01 以降に投稿されたもの。  |
...
| 値                                            | 取得するエントリ                 |
| -------------------------------------------- | ------------------------ |
| `32069668'foo'`                              | ハンドルが `foo` のセクション内。     |
...
| 値                                    | 取得するエントリ            |
| ------------------------------------ | ------------------- |
| `8296'foo'787'foo'`                  | ハンドルが `foo` のサイトから。 |
...
| 値                       | 取得するエントリ                        |
| ----------------------- | ------------------------------- |
| `'9'foo'25590'foo'`     | ハンドルが `foo` のタイプ。               |
