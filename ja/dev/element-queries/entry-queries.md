...
| 値                                                                                                         | 取得するエントリ                |
| --------------------------------------------------------------------------------------------------------- | ----------------------- |
| `'c548224.9'>= 2018-04-01'22'>= 2018-04-01''>= 2018-04-01'3'>= 2018-04-01''>= 2018-04-01'` | 2018-04-01 以降に投稿されたもの。  |
...
| 値                                            | 取得するエントリ                 |
| -------------------------------------------- | ------------------------ |
| `o'9864'foo'0'foo'`                          | ハンドルが `foo` のセクション内。     |
