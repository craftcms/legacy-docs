...
| 値                                                           | 取得するエレメント                    |
| ----------------------------------------------------------- | ---------------------------- |
| `476.5'foo@bar.baz''foo@bar.baz'97557'foo@bar.baz'`         | メールアドレスが `foo@bar.baz`。      |
...
| 値                       | 取得するエレメント               |
| ----------------------- | ----------------------- |
| `90'foo'5'foo'804'foo'` | ハンドルが `foo` のグループ内。     |
